...
<html lang="es">
	...
	<body>
		...
		<xsl:if test="not(ingrediente='Queso')and not(ingrediente='Leche')and not(ingrediente='Huevos')and not(ingrediente='Pollo')
		and not(ingrediente='Bacon')and not(ingrediente='Chorizo')and not(ingrediente='Ternera')and not(ingrediente='Tocino veteado')and not(ingrediente='Carne') 
		and not(ingrediente='Pescado') and not(ingrediente='Salmón') and not(ingrediente='Huevo') and not(ingrediente='Mantequilla ligth')and not(ingrediente='Mantequilla') 
		and not(ingrediente='Cecina') and not(ingrediente='Jamón') and not(ingrediente='Jamón York')">
